...
def get_default_config():
    ...
    with open("/home/ahmad/GRACE/RecSys/config/default_config.yaml", 'r', encoding="utf-8") as config_file:
...
def load_data(dataset, test=False):
    ...
    """
    # Users
    if os.path.exists(f"/home/ahmad/GRACE/data/{dataset}/users.csv"):
        users_df = pd.read_csv(f"/home/ahmad/GRACE/data/{dataset}/users.csv")
    else:
        users_df = None

    # Items
    if os.path.exists(f"/home/ahmad/GRACE/data/{dataset}/items.csv"):
        items_df = pd.read_csv(f"/home/ahmad/GRACE/data/{dataset}/items.csv")
    else:
        items_df = None

    # Interactions
    inter_df = pd.read_csv(f"/home/ahmad/GRACE/data/{dataset}/split/interactions_train.csv")
    val_inter_df = pd.read_csv(f"/home/ahmad/GRACE/data/{dataset}/split/interactions_val.csv")
    if test:
        test_inter_df = pd.read_csv(f"/home/ahmad/GRACE/data/{dataset}/split/interactions_test.csv")
